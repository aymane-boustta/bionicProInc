...
public class Main {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		*/
		...
		//testing
		/*
		Material m = new Material("Polyethylene",6.75f,5000);
		Material m1 = new Material("Polypropylene",9.75f,4000);
		Material m2 = new Material("Acrylics",3.25f,1000);
		Material m3 = new Material("Titanium",16.75f,10000);
		Material m4 = new Material("Carbon fiber",20.75f,20000);
		Material m5 = new Material("Aluminuim",11.75f,20000);
		Material m6 = new Material("Polyurethane",10.75f,8000);
		j.addMaterial(m);
		j.addMaterial(m1);
		j.addMaterial(m2);
		j.addMaterial(m3);
		...
		*/
		...
		j.addProdIntoCh(p4, ch1);
		j.addProdIntoCh(p3, ch6);
		j.addProdIntoCh(p4, ch6);
		j.addProdIntoCh(p1, ch10);
		j.addProdIntoCh(p2, ch10);
		j.addProdIntoCh(p1, ch9);
		j.addProdIntoCh(p2, ch9);
